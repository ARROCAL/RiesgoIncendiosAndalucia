    ...
    var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      _onCbxUseSpatialClicked: function() {
        if (this.cbxUseSpatial.checked) {
          ...
          html.setStyle(this.drawBox.triangleIcon, 'display', 'none');
          html.setStyle(this.drawBox.circleIcon, 'display', 'none');
          html.setStyle(this.drawBox.ellipseIcon, 'display', 'none');
        } else {
